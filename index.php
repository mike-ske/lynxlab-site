                        ...
                        <div class="splide__track">
                            <ul class="splide__list">
                                ...
                                <li class="splide__slide">
                                    <div class="text_bx">
                                        <p class="x1">
                                            ‘‘Nowadays, it isn’t great DNA services especially in the Africa region. 
                                            But Lynx DNA surprises me with its great service and commitment. Kudos!
                                        </p>
                                        <span class="line"></span>
                                        <h3 class="x1_name">Mary Balogun</h3>
                                    </div>
                                </li>
                                ...
                                <li class="splide__slide">
                                    <div class="text_bx">
                                        ...
                                        <span class="line"></span>
                                        <h3 class="x1_name">David Gillroy</h3>
                                    </div>
                                </li>
                                ...
                                <li class="splide__slide">
                                    <div class="text_bx">
                                        ...
                                        <span class="line"></span>
                                        <h3 class="x1_name">John Peter</h3>
                                    </div>
                                </li>
            ...
            <div class="blg_bx">
                ...
                <div class="blg_set">
                    <h3 class="blg_h3" id="blg_h3" style="display: flex;align-items:center;justify-content:space-between">
                        ...
                        <div class="small" style="font-size: 55%;width:50%;font-weight: 400;color: #b7b9cc"><?php echo convertYear($value['created_date'])?></div>
                    </h3>
