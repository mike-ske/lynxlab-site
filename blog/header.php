...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
      ...
      <?php if(isset($_SERVER['REQUEST_URI'] ) && $_SERVER['REQUEST_URI'] === '/about-us'){ ?>
        ...
        <meta property="og:title" content="Affordable DNA Testing Center Near You | Lynx DNA Lab">
        <meta property="og:description" content="We are Lynx DNA Laboratory, a Private DNA Testing Center with Accredited Test Centers in Major Cities in Nigeria. We Are Affiliated to GENETICA DNA and DDC in Ohio, United States.">
        <meta property="og:image" content="http://www.lynxlaboratories.com.ng/img/bg/image 21.png">
            
        <!-- Twitter Meta Tags -->
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="Affordable DNA Testing Center Near You | Lynx DNA Lab">
      ...
      <?php  }else if(isset($_SERVER['REQUEST_URI'] ) && $_SERVER['REQUEST_URI'] === '/DNA-service'){ ?>
        ...
        <meta property="fb:app_id" content="1077364553177489" />
              <!-- Twitter Meta Tags -->
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="Best DNA Test Center in Lagos, Nigeria | Lynx DNA Lab">
        <meta name="twitter:description" content="We are Lynx DNA Laboratory, a Private DNA Testing Center with Accredited Test Centers in Major Cities in Nigeria. We Are Affiliated to GENETICA DNA and DDC in Ohio, United States.">
        <meta name="twitter:image" content="http://www.lynxlaboratories.com.ng/img/bg/image 21.png">
